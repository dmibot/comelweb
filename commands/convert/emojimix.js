...
module.exports = {
    ...
    start: async(comel, m, { text }) => {
        ...
        for (let url of fetch.results) {
            ...
            comel.sendMessage(m.from, message, { quotedMessageId: m.id._serialized, sendMediaAsSticker: true, stickerName: global.packname, stickerAuthor: global.author, stickerCategories: ['😎','😾','🗿'] })
        }
    },
    isQuery: true
}